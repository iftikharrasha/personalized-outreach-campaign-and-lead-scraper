...
import { Archive, Check, CheckCircle, ChevronDown, ChevronLeft, ChevronRight, Download, Filter, Mail, MapPin, Pencil, Phone, Play, StickyNote, User, X } from "lucide-react";
    ...
    <div className="px-8 py-8 max-w-[1480px] mx-auto pb-32">
      ...
      <div className="flex items-start justify-between gap-6 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <Button variant="primary" size="md" leftIcon={<Play size={14} />} disabled>
            Run campaign
          </Button>
          <Menu
          ...
          <Button variant="chip" size="md" onClick={handleArchive} leftIcon={<Archive size={14} />}>Archive</Button>
        </div>
      </div>
              ...
              {pageRows.length === 0 && (
                <tr>
                  <td colSpan={8} className="py-16 text-center text-mute text-sm">
                    {leads.length === 0
                      ? "No leads yet. Run the campaign to start scraping (available in Phase 2)."
      ...
      {/* Run history */}
      <div className="mt-6">
        <RunHistoryCard runs={[]} subtitle="No runs for this campaign yet" />
      </div>
